...
class Tela_Excluir(Screen):
      def clear_fields(self):
            ...
            self.ids.excluir_button.disabled = True
      ...
      def consulta_func(self):
            ...
            try:
                  ...
                  self.ids.excluir_button.disabled = False
      ...
      def excluir_func(self):
            ...
            if crud.excluirFuncionario(var_id):
                  self.clear_fields()
                  self.ids.resposta.text = "Usuário excluido com sucesso!"